...
import { getValidationLevelColor, IValidationMessageProps } from 'components/Input/ValidationMessages';
...
export const Signature: FC<IProps> = ({ saveClick, editClick, interacted, validationLevel }) => {
